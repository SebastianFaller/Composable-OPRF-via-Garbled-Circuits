...
# This file was *autogenerated* from the file ADDS_oprf_user.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_64 = Integer(64); _sage_const_32 = Integer(32); _sage_const_8 = Integer(8); _sage_const_1024 = Integer(1024); _sage_const_96 = Integer(96); _sage_const_256 = Integer(256); _sage_const_1000 = Integer(1000); _sage_const_1000p0 = RealNumber('1000.0')
...
def sendAndRecData(data, HOST, PORT):
    ...
    try:
        ...
        print(HOST + ":" +str(PORT))
        sock.sendall(len(data).to_bytes(_sage_const_8 , 'big') + data)

        expected_size = sock.recv(_sage_const_8 )
        count = int.from_bytes(expected_size, 'big')
        while count > _sage_const_0 :
            received += sock.recv(_sage_const_1024 )
            count -= _sage_const_1024 
    except:
        pass
    finally:
        sock.close()
...
def runUser(host, port):
    print("starting...")
    cls = VOPRFPoC; p = _sage_const_3 ; q_size = _sage_const_96 ; n = _sage_const_256 
    ...
    time_stamps = []
    space_stamps = []
    nr_iterations = _sage_const_1000 
    for i in range(nr_iterations):
        ...
        cx = voprf.bp14(bits) + voprf.a[_sage_const_2 ] * s + e1
...
#        cx = ZZ["x"]
        ...
        y = voprf.nice_lift((dx - voprf.c * s)[_sage_const_0 ])
...
if __name__ == "__main__":
    main(sys.argv[_sage_const_1 ], sys.argv[_sage_const_2 ])
