...
# This file was *autogenerated* from the file ADDS_oprf_server.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_64 = Integer(64); _sage_const_32 = Integer(32); _sage_const_8 = Integer(8); _sage_const_512 = Integer(512); _sage_const_96 = Integer(96); _sage_const_256 = Integer(256)
import chunk
...
def voprfServer (msg):
    ...
    cx = loads(msg)
    e_ = voprf.sample_small(bound =_sage_const_2 **_sage_const_64 , scalar = False)
